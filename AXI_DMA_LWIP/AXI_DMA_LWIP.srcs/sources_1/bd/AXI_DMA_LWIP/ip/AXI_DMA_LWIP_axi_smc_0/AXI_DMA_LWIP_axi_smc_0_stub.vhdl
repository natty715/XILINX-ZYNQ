...
-- Date        : Mon Mar  4 23:27:00 2019
-- Host        : SEELE-PC running 64-bit Service Pack 1  (build 7601)
-- Command     : write_vhdl -force -mode synth_stub -rename_top AXI_DMA_LWIP_axi_smc_0 -prefix
--               AXI_DMA_LWIP_axi_smc_0_ AXI_DMA_LWIP_axi_smc_0_stub.vhdl
-- Design      : AXI_DMA_LWIP_axi_smc_0
...
entity AXI_DMA_LWIP_axi_smc_0 is
  Port ( 
    aclk : in STD_LOGIC;
...
end AXI_DMA_LWIP_axi_smc_0;

architecture stub of AXI_DMA_LWIP_axi_smc_0 is
...
attribute X_CORE_INFO of stub : architecture is "bd_bd24,Vivado 2017.4";
begin
end;
