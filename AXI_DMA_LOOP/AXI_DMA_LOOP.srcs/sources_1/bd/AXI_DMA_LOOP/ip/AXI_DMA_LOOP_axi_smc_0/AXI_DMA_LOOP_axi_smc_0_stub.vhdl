...
-- Date        : Sat Mar  2 15:18:28 2019
-- Host        : SEELE-PC running 64-bit Service Pack 1  (build 7601)
-- Command     : write_vhdl -force -mode synth_stub -rename_top AXI_DMA_LOOP_axi_smc_0 -prefix
--               AXI_DMA_LOOP_axi_smc_0_ AXI_DMA_LOOP_axi_smc_0_stub.vhdl
-- Design      : AXI_DMA_LOOP_axi_smc_0
...
entity AXI_DMA_LOOP_axi_smc_0 is
  Port ( 
    aclk : in STD_LOGIC;
...
end AXI_DMA_LOOP_axi_smc_0;

architecture stub of AXI_DMA_LOOP_axi_smc_0 is
...
attribute X_CORE_INFO of stub : architecture is "bd_6d0d,Vivado 2017.4";
begin
end;
